...
🚀 My stack spans from **Flutter** (for cross-platform mobile/web) and **Python/FastAPI** on the back, with AI and real-time integrations.

---

## 📚 Currently Focusing On
- ✨ Flutter for cross-platform mobile and web development (delivering pixel-perfect UI)
- 🐍 Python (with FastAPI) for scalable, AI-enhanced backend APIs and robust data processing
- 🔐 Firebase for real-time features and authentication
- 🗄️ Implementing PostgreSQL for robust data management in current projects
...
### 🔹 Previous Experience (Freelance & Projects)
...
## 🧠 Quote
*"Building apps with purpose — combining Flutter, AI and data to empower families and create real impact."*